...
INSERT INTO TIP (TIP_ID, TIP_TITLE, SITE_ID,LAST_UPD_DATE, LAST_UPD_BY, OBSOLETE_FLAG) Values (16, 'A row without abstract and description', 9, TO_DATE('12/09/2012 23:30:39', 'MM/DD/YYYY HH24:MI:SS'), 'NOBODY', 'N');
